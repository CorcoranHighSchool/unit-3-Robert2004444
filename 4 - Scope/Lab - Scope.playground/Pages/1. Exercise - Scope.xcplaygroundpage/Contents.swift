...
//print("The value of foo is \(foo)")
//Because foo is declare on the for loop is trying to be accessed outside its scope
...
//x is declared as global scope on line 14 and therefore can be accessed and modified as any further restricting scope.
