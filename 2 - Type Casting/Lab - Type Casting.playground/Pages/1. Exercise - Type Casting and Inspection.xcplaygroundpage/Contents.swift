 ...
 */
var mystuff : [Any] = [5,20.17, "Cookies", true, true, 700, 70.1, "Parrots", "Blanket"]
print(mystuff)
...
var myLookup : [String : Any] = ["Age": 18, "Name" : "Sammy", "Cost" : 29.95, "True?" : false, "Ask Marc" : "I was trying to figure out why I have all these errors", "Okay" : -0, "Are you sure" : true]
print(myLookup)
